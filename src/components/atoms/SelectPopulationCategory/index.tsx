  ...
  return (
    <div className={styles['container']}>
      <select value={categoryLabel} onChange={handleChange} className={styles['select']}>
        <option value='総人口' data-selected={categoryLabel === '総人口'} className={styles['select-option']}>
          総人口
        </option>
        <option value='年少人口' data-selected={categoryLabel === '年少人口'} className={styles['select-option']}>
          年少人口
        </option>
        <option
          value='生産年齢人口'
          data-selected={categoryLabel === '生産年齢人口'}
          className={styles['select-option']}
        >
          生産年齢人口
        </option>
        <option value='老年人口' data-selected={categoryLabel === '老年人口'} className={styles['select-option']}>
          老年人口
        </option>
      </select>
